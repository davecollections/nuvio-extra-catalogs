...
- Thirty-four deterministic Golden Globes catalogues: 23 movie and 11 series payloads covering all 27 catalogue-compatible current categories. Best Podcast remains canonical data only because Stremio has no podcast catalogue type.
...
- The existing all-awards manifest URL advances to version `1.1.0`, declares both `movie` and `series`, and preserves all 24 released Academy catalogue IDs while adding the 34 Golden Globes IDs.
...
- Golden Globes contracts pass with 1,689 results and 1,591 unique catalogue Meta Preview items across 23 movie and 11 series catalogues.
...
- The all-awards manifest and both award presets pass exact route, payload-shape, media-type, byte-equality, and catalogue-set validation: 47 movie and 11 series catalogues with 3,645 total all-awards Meta Preview items.
